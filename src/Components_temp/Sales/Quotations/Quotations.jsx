...
function Quotations() {
  ...
  const [rows] = useState([]); // no data (blank as in screenshot)

  const columns = [
    "SL", "Date", "Invoice No", "Customer",
    "Warehouse", "User", "Convert Status", "Action"
  ];
  ...
  return (
    <div className="quotations-container">
      <div className="main-title">Quotations</div>
      <div className="top-bar">
        <div className="topbar-left">
          ...
          <button className="add-btn">+ New Quotation</button>
        </div>
          ...
          <tbody>
            <tr>
              <td colSpan={columns.length} className="empty">
                {/* stays empty as in your screenshot */}
              </td>
            </tr>
          </tbody>
        </table>
