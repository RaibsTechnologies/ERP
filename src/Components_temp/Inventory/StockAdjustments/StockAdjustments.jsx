  ...
  return (
    <div className="tp-container">
      <div className="tp-header-row">
        <h2 className="tp-title">Stock Adjustments</h2>
        <button className="tp-add-btn">+ Add Stock Adjustments</button>
      </div>
          ...
          {products.length === 0 ? (
            ...
            products.map((item, idx) => (
              <tr key={item.id}>
                <td>{idx + 1}</td>
                <td>{item.date}</td>
                <td>{item.branchOrWarehouse}</td>
                <td>{item.referenceNo}</td>
                <td>{item.recoveryAmount}</td>
