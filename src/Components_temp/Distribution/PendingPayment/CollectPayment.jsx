...
function CollectPayment() {
  ...
  return (
    <div className="collectpayment-container">
      {/* Title */}
      <div className="main-title-row">
        <span className="main-title">Collect Payments</span>
      </div>
      ...
      <div className="table-title-row">
        ...
        <button className="table-view-icon" title="List">&#9776;</button>
        <button className="table-view-icon" title="Grid">&#9638;</button>
        <input
      ...
      <div className="table-scroll-area">
        <table className="collectpayment-table">
          <thead>
            <tr>
              <th></th>
              <th>SL</th>
          ...
          <tbody>
            <tr>
              <td colSpan={7} className="empty">
                {/* Blank, just like your screenshot */}
              </td>
            </tr>
          </tbody>
        </table>
